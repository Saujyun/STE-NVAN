...
#                     --model_type 'resnet50_NL' --num_workers 16 --track_per_class 4 --S 8 --latent_dim 2048 --temporal Done  --track_id_loss \
#                     --non_layers  0 2 3 0
...
python3 train_NL.py --train_txt $TRAIN_TXT --train_info $TRAIN_INFO  --batch_size 64 \
                     --test_txt $TEST_TXT  --test_info  $TEST_INFO   --query_info $QUERY_INFO \
                     --n_epochs 200 --lr 0.0001 --lr_step_size 50 --optimizer adam --ckpt $CKPT --log_path loss_ste_nvan.txt --class_per_batch 8 \
